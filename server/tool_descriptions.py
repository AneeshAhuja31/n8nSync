fetch_exisiting_workflow_description="""
    ...
    Returns:
    - Dict[str, Any]: Success response with workflow data or error information
        Success format: {"success": True, "workflow": {...workflow_json...}}
...
get_all_exisiting_workflows_description = """
    ...
    Returns:
    - Dict[str, Any]: Success response with list of workflows or error information
        Success format: {"success": True, "workflow": [{"name": "...", "id": "...", "active": true/false}, ...]}
        Error format: {"success": False, "error": "Error message", "status_code": int}
        Empty list format: [] (when no workflows exist)
...
create_workflow_from_prompt_description = """
    ...
    Returns:
    - Dict[str, Any]: Complete n8n workflow JSON object ready for import
        Format: {
            "name": "Workflow Name",
            "nodes": [...],
            "connections": {...},
...
explain_workflow_description = """
    ...
    Returns:
    - Dict[str, Any]: Analysis result with explanation or error information
        Success format: {"success": True, "explanation": "Detailed explanation..."}
        Error format: {"success": False, "error": "Error message"}
...
modify_workflow_description = """
    ...
    Returns:
    - Dict[str, Any]: Modified workflow result or error information
        Success format: {"success": True, "modified_workflow": {...complete_workflow_json...}}
        Error format: {"success": False, "error": "Error message"}
