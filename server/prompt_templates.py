...
### Key Principles:
1. **Technical Accuracy**: Ensure all generated workflows follow proper n8n JSON structure and conventions
2. **Security Awareness**: Remind users about API key security and credential management
